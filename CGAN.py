...
class generator(nn.Module):
    ...
    def __init__(self, input_dim=100, output_dim=1, input_size=32, class_num=12):
...
class discriminator(nn.Module):
    ...
    def __init__(self, input_dim=1, output_dim=1, input_size=32, class_num=14):
...
class CGAN(object):
    def __init__(self, args):
        ...
        # load dataset
        self.data_loader = dataloader(self.dataset_path, self.input_size, self.batch_size)
