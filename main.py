...
def parse_args():
    ...
    parser.add_argument('--dataset_path', type=str, default='./dataset/data_single_label.csv',
                        help='The path of dataset')
    parser.add_argument('--dataset', type=str,
                        default='fem_data_train',
    ...
    parser.add_argument('--input_size', type=int, default=88, help='The size of input image')
